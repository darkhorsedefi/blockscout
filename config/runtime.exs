...
config :block_scout_web, :footer,
  ...
  chat_link: System.get_env("FOOTER_CHAT_LINK", "https://discord.gg/wUzME6vHz8"),
  github_link: System.get_env("FOOTER_GITHUB_LINK", "https://github.com/Nexis-Network"),
  forum_link_enabled: ConfigHelper.parse_bool_env_var("FOOTER_FORUM_LINK_ENABLED"),
  forum_link: System.get_env("FOOTER_FORUM_LINK", "https://nexisetwork.medium.com/"),
